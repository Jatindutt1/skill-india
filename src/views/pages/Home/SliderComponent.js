...
export default function SliderComponent() {
  ...
  return (
    <div>
      <Slider {...settings} className='slick-active-main'>
        {sliderData.map((slide, index) => (
          <div key={index}>
            <div className='slider-image-box' style={{ background: `url("${slide.imageUrl}")` }}></div>
          </div>
        ))}
      </Slider>
    </div>
