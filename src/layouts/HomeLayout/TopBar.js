    ...
    return headersData.map(({ label, href, icon }) => {
      return (
        <>
          ...
          >
            <div style={{ fontSize: "19px", marginRight: "5px" }}>{icon}</div>{" "}
            {label}
          </Button>
        </>
      );
      ...
      >
        <Container>
          ...
          >
            ...
            <Box style={{display:"flex" ,gap:"15px"}} className="paddingBox">
              <Typography
                variant="body1"
                style={{ color: "#cccccc", marginLeft: "10px" }}
              >
              ...
              <Box style={{display:"flex" ,gap:"8px",cursor:"pointer"}}>
                <IoLocationOutline style={{ color: "#cccccc",fontSize:"17px" }} />
                <Typography
                variant="body1"
                style={{ color: "#cccccc" }}
              >
              ...
              <Box style={{display:"flex" ,gap:"8px",cursor:"pointer"}}>
                <AiOutlineGlobal style={{ color: "#cccccc",fontSize:"17px" }} />
                <Typography
                variant="body1"
                style={{ color: "#cccccc" }}
              >
